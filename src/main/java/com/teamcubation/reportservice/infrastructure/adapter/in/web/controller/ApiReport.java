...
public interface ApiReport {
    ...
    ResponseEntity<byte[]> downloadFile(String typeFile, String typeInstrument) throws IOException, InvalidObjectException;
    ...
    ResponseEntity<List<Report>> getAllReports() throws InvalidObjectException;
}
